...
function extractPlace(title, district) {
  ...
  t = t.replace(/(幼儿园|幼儿|小[一二三四五六]|一年级|二年级|三年级|四年级|五年级|六年级|小学|初一|初二|初三|初中|高一|高二|高三|高中|成人|大学|全职住家|语文|数学|英语|物理|化学|生物|政治|历史|地理|科学|体育|音乐|美术|书法|油画|p5\.js|编程|微积分|陪玩|托管|作业辅导).*$/i, '');
  return t
    .replace(/^市/, '')
    .replace(/^[#＃.。·\-—–\s]+/, '')
    .replace(/^(附近|地铁站)/, '')
