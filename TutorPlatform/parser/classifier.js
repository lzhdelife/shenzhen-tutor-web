...
function classifyOrderBlock(value) {
  ...
  const evidence = {
    ...
    subject: /(?:语文|数学|英语|物理|化学|生物|政治|历史|地理|数理化|语数英|全科|奥数|科学|编程|微积分|陪读|作业辅导)/i.test(text),
    location: /(?:深圳|罗湖|福田|南山|盐田|宝安|龙岗|龙华|坪山|光明|大鹏|线上|网课|\d{1,2}号线|地铁站|街道|社区|花园|小区|公馆|家园|华府|新村|中心|广场|大厦|公寓|附近)/.test(text),
